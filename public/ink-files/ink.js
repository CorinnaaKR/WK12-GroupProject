...
!(function (t, e) {
        ...
        if (null == this.parent) this._path = new e();
          ...
          for (; null !== i; ) {
            ...
            if (null != r && r.hasValidName) {
              if (null === r.name) return p("namedChild.name");
              t.unshift(new e.Component(r.name));
            } else t.unshift(new e.Component(i.content.indexOf(n)));
            (n = i), (i = s(i.parent, x));
          }
          this._path = new e(t);
        }
  ...
  class S extends Map {
    constructor() {
      if (
        ...
        let t = arguments[0],
          e = t.originNames;
        null !== e && (this._originNames = e.slice()),
    ...
    HasIntersection(t) {
      for (let [e] of this) if (t.has(e)) return !0;
      return !1;
    }
    Without(t) {
      let e = new S(this);
    ...
    ListWithSubRange(t, e) {
      ...
      Number.isInteger(t)
        ...
        Number.isInteger(e)
          ? (r = e)
          : e instanceof S && e.Count > 0 && (r = e.maxItem.Value);
      let a = new S();
  ...
  class C extends m {
    ...
    Copy() {
      return l(C.Create(this.valueObject), m);
    }
    BadCastException(t) {
      return new y(
        "Can't cast " +
  ...
  class N extends b {
    ...
    Copy() {
      return new N(this.variableName, this.contextIndex);
    }
  }
  class O extends b {
    get isTruthy() {
  ...
  class k extends m {
    ...
    static BeginTag() {
      return new k(k.CommandType.BeginTag);
    }
    static EndTag() {
      return new k(k.CommandType.EndTag);
    }
    toString() {
  ...
  class j extends m {
    ...
    set name(t) {
      (this._name = t),
        this._isPrototype ||
          (null === j._nativeFunctions
            ? p("NativeFunctionCall._nativeFunctions")
            : (this._prototype = j._nativeFunctions.get(this._name) || null));
    }
    ...
    CallListIncrementOperation(t) {
      ...
      for (let [t, a] of e.value) {
        ...
        if (null != h) {
          let t = h.TryGetItemWithValue(o, g.Null);
    ...
    constructor() {
      if (
        ...
        j.GenerateNativeFunctionsIfNecessary();
      else if (1 === arguments.length) {
        let t = arguments[0];
        j.GenerateNativeFunctionsIfNecessary(), (this.name = t);
    ...
    static GenerateNativeFunctionsIfNecessary() {
      if (null == this._nativeFunctions) {
        (this._nativeFunctions = new Map()),
          ...
          this.AddIntUnaryOp(this.Floor, j.Identity),
          this.AddIntUnaryOp(this.Ceiling, j.Identity),
          this.AddIntUnaryOp(this.Int, j.Identity),
          ...
          this.AddFloatUnaryOp(this.Float, j.Identity),
    ...
    static AddOpToNativeFunc(t, e, n, i) {
      ...
      r || ((r = new j(t, e)), this._nativeFunctions.set(t, r)),
  ...
  (j.Add = "+"),
    ...
    (j.All = "LIST_ALL"),
    (j.Count = "LIST_COUNT"),
    (j.ValueOfList = "LIST_VALUE"),
    (j.Invert = "LIST_INVERT"),
    (j._nativeFunctions = null);
  class B extends m {
    constructor(t) {
  ...
  class q {
    ...
    static WriteRuntimeObject(t, e) {
      ...
      let h = s(e, T);
      if (h) return void t.WriteFloat(h.value);
      let u = s(e, E);
      if (u)
        return void (u.isNewline
          ? t.Write("\n", !1)
          : (t.WriteStringStart(),
            t.WriteStringInner("^"),
            t.WriteStringInner(u.value),
            t.WriteStringEnd()));
      let c = s(e, O);
      ...
      if (s(e, D)) return void t.Write("void");
      let v = s(e, B);
      if (v)
        return (
          t.WriteObjectStart(),
          t.WriteProperty("#", v.text),
          void t.WriteObjectEnd()
        );
      let C = s(e, G);
      if (!C)
        throw new Error("Failed to convert runtime object to Json token: " + e);
      this.WriteChoice(t, C);
    }
    ...
    static JTokenToRuntimeObject(t) {
      ...
      if ("string" == typeof t) {
        ...
        if (("L^" == e && (e = "^"), j.CallExistsWithName(e)))
          return j.CallWithName(e);
        if ("->->" == e) return k.PopTunnel();
        if ("~ret" == e) return k.PopFunction();
        if ("void" == e) return new D();
      }
    ...
    static toJson(t, e, n) {
      return JSON.stringify(
        t,
        (t, n) => ((null == e ? void 0 : e.some((e) => e === t)) ? void 0 : n),
        n
      );
    }
    static WriteRuntimeContainer(t, e) {
    ...
    static WriteChoice(t, e) {
      t.WriteObjectStart(),
        ...
        e.tags &&
          t.WriteProperty("tags", (t) => {
            t.WriteArrayStart();
            for (const n of e.tags)
              t.WriteStringStart(), t.WriteStringInner(n), t.WriteStringEnd();
            t.WriteArrayEnd();
          }),
        t.WriteObjectEnd();
    }
  ...
  q._controlCommandNames = (() => {
    ...
    (t[k.CommandType.EvalStart] = "ev"),
      ...
      (t[k.CommandType.BeginTag] = "#"),
      (t[k.CommandType.EndTag] = "/#");
  ...
  class U {
    ...
    Push(t) {
      let e =
        ...
        i = new U.Element(t, this.currentElement.currentPointer, !1);
    ...
    SetTemporaryVariable(t, e, n) {
      ...
      let a = v(r.temporaryVariables, t, null);
      a.exists && O.RetainListOriginsForAssignment(a.result, e),
        ...
        if (
          ...
          for (let t of r) {
            ...
            let h = !!a.exp,
              ...
              c = a.temp;
            void 0 !== c
              ? (u.temporaryVariables = q.JObjectToDictionaryRuntimeObjs(c))
              : u.temporaryVariables.clear(),
  ...
  class K extends class {} {
    ...
    RuntimeObjectsEqual(t, e) {
      ...
      let a = s(t, b),
        o = s(e, b);
      if (null !== a && null !== o)
        return u(a.valueObject) && u(o.valueObject)
    ...
    GetRawVariableWithName(t, e) {
      ...
      if (0 == e || -1 == e) {
        ...
        if (
          ...
          return e.result;
        if (((e = v(this._globalVariables, t, null)), e.exists))
          return e.result;
        if (
          null !== this._defaultGlobalVariables &&
          ((e = v(this._defaultGlobalVariables, t, null)), e.exists)
        )
          return e.result;
    ...
    Assign(t, e) {
      ...
      if (
        ...
        let t = null;
        do {
          (t = s(this.GetRawVariableWithName(n, i), N)),
            null != t &&
    ...
    SetGlobal(t, e) {
      let n = null;
      if (
        (null === this.patch && (n = v(this._globalVariables, t, null)),
        null !== this.patch &&
          ((n = this.patch.TryGetGlobal(t, null)),
          n.exists || (n = v(this._globalVariables, t, null))),
        O.RetainListOriginsForAssignment(n.result, e),
        null === t)
      )
    ...
    ResolveVariablePointer(t) {
      ...
      let n = s(this.GetRawVariableWithName(t.variableName, e), N);
      return null != n ? n : new N(t.variableName, e);
    }
    ...
    LoadFlowChoiceThreads(t, e) {
      for (let n of this.currentChoices) {
        ...
        if (null !== i) n.threadAtGeneration = i.Copy();
          ...
          let i = t["".concat(n.originalThreadIndex)];
  ...
  class Y {
    ...
    VisitCountAtPathString(t) {
      ...
      return (n = v(this._visitCounts, t, null)), n.exists ? n.result : 0;
    }
    ...
    get currentText() {
      if (this._outputStreamTextDirty) {
        let t = new f(),
          e = !1;
        for (let n of this.outputStream) {
          let i = s(n, E);
          if (e || null === i) {
            let t = s(n, k);
            null !== t &&
              (t.commandType == k.CommandType.BeginTag
                ? (e = !0)
                : t.commandType == k.CommandType.EndTag && (e = !1));
    ...
    get currentTags() {
      if (this._outputStreamTagsDirty) {
        ...
        for (let n of this.outputStream) {
          let i = s(n, k);
          if (null != i) {
            if (i.commandType == k.CommandType.BeginTag) {
              if (t && e.Length > 0) {
                let t = this.CleanOutputWhitespace(e.toString());
                this._currentTags.push(t), e.Clear();
              }
              t = !0;
            } else if (i.commandType == k.CommandType.EndTag) {
              if (e.Length > 0) {
                let t = this.CleanOutputWhitespace(e.toString());
                this._currentTags.push(t), e.Clear();
              }
            ...
            let t = s(n, E);
            null !== t && e.Append(t.value);
          } else {
            let t = s(n, B);
            null != t &&
              null != t.text &&
              t.text.length > 0 &&
              this._currentTags.push(t.text);
          }
        }
        if (e.Length > 0) {
          let t = this.CleanOutputWhitespace(e.toString());
    ...
    CopyAndStartPatching() {
      ...
      if (
        ...
        for (let [e, n] of this._namedFlows)
          t._namedFlows.set(e, n), (t._aliveFlowNamesDirty = !0);
    ...
    TrySplittingHeadTailWhitespace(t) {
      ...
      if ((-1 != r && (o = a), o > l)) {
        let t = e.substring(l, o);
        s.push(new E(t));
      }
      if (-1 != r && a > i && (s.push(new E("\n")), r < e.length - 1)) {
        let t = e.length - r - 1,
          n = new E(e.substring(r + 1, r + 1 + t));
        s.push(n);
      }
      return s;
    }
    ...
    PopEvaluationStack(t) {
      if (void 0 === t) {
        return h(this.evaluationStack.pop());
      }
      if (t > this.evaluationStack.length)
        throw new Error("trying to pop too many objects");
      return h(this.evaluationStack.splice(this.evaluationStack.length - t, t));
    }
    PeekEvaluationStack() {
      ...
      if (null !== t)
        for (let e = 0; e < t.length; e++) {
          if (
            ...
            throw new Error((h(arguments[e]), "null"));
  ...
  class Z extends m {
    ...
    PopChoiceStringAndTags(t) {
      let e = l(this.state.PopEvaluationStack(), E);
      for (
        ;
        this.state.evaluationStack.length > 0 &&
        null != s(this.state.PeekEvaluationStack(), B);

      ) {
        let e = s(this.state.PopEvaluationStack(), B);
        e && t.push(e.text);
      }
      return e.value;
    }
    ProcessChoice(t) {
      ...
      let n = "",
        ...
        r = [];
      if (
        (t.hasChoiceOnlyContent && (i = this.PopChoiceStringAndTags(r) || ""),
        t.hasStartContent && (n = this.PopChoiceStringAndTags(r) || ""),
        t.onceOnly)
      ) {
        ...
        switch (e.commandType) {
          ...
          case k.CommandType.BeginString:
            this.state.PushToOutputStream(e),
              ...
              (this.state.inExpressionEvaluation = !1);
            break;
          case k.CommandType.BeginTag:
            this.state.PushToOutputStream(e);
            break;
          case k.CommandType.EndTag:
            if (this.state.inStringEvaluation) {
              let t = [],
                e = 0;
              for (let n = this.state.outputStream.length - 1; n >= 0; --n) {
                let i = this.state.outputStream[n];
                e++;
                let r = s(i, k);
                if (null != r) {
                  if (r.commandType == k.CommandType.BeginTag) break;
                  this.Error(
              ...
              let n = new f();
              for (let e of t.reverse()) n.Append(e.toString());
              let i = new B(this.state.CleanOutputWhitespace(n.toString()));
              this.state.PushEvaluationStack(i);
            } else this.state.PushToOutputStream(e);
            break;
          case k.CommandType.EndString: {
            ...
            for (let i = this.state.outputStream.length - 1; i >= 0; --i) {
              let r = this.state.outputStream[i];
              n++;
              let a = s(r, k);
              if (a && a.commandType == k.CommandType.BeginString) break;
              r instanceof B && e.push(r), r instanceof E && t.push(r);
            }
            this.state.PopFromOutputStream(n);
            for (let t of e) this.state.PushToOutputStream(t);
            t = t.reverse();
            let i = new f();
            for (let e of t) i.Append(e.toString());
            (this.state.inExpressionEvaluation = !0),
              this.state.PushEvaluationStack(new E(i.toString()));
            break;
          }
          case k.CommandType.ChoiceCount:
            let i = this.state.generatedChoices.length;
            this.state.PushEvaluationStack(new w(i));
            break;
          ...
          case k.CommandType.ReadCount:
            ...
            let o,
              h = l(a, P),
              u = s(this.ContentAtPath(h.targetPath).correctObj, x);
            null != u
              ? (o =
                  e.commandType == k.CommandType.TurnsSince
                    ? this.state.TurnsSinceForContainer(u)
                    : this.state.VisitCountForContainer(u))
              : ((o = e.commandType == k.CommandType.TurnsSince ? -1 : 0),
                this.Warning(
                  "Failed to find container for " +
                    e.toString() +
                    " lookup at " +
                    h.targetPath.toString()
                )),
              this.state.PushEvaluationStack(new w(o));
            break;
          ...
          case k.CommandType.SeedRandom:
            ...
            (this.state.storySeed = c.value),
              ...
              this.state.PushEvaluationStack(new D());
            break;
          case k.CommandType.VisitIndex:
            ...
            this.state.PushEvaluationStack(new w(d));
            break;
          case k.CommandType.SequenceShuffleIndex:
            let m = this.NextSequenceShuffleIndex();
            this.state.PushEvaluationStack(new w(m));
            break;
          ...
          case k.CommandType.ListFromInt:
            let v = s(this.state.PopEvaluationStack(), w),
              C = l(this.state.PopEvaluationStack(), E);
            if (null === v)
              throw new y(
            ...
            let T = this.listDefinitions.TryListGetDefinition(C.value, null);
            if (!T.exists) throw new y("Failed to find LIST called " + C.value);
            {
              if (null === v.value) return p("minInt.value");
              let t = T.result.TryGetItemWithValue(v.value, g.Null);
              t.exists && (_ = new O(t.result, v.value));
            }
            null == _ && (_ = new O()), this.state.PushEvaluationStack(_);
            break;
          case k.CommandType.ListRange:
            let N = s(this.state.PopEvaluationStack(), b),
              A = s(this.state.PopEvaluationStack(), b),
              I = s(this.state.PopEvaluationStack(), O);
            if (null === I || null === A || null === N)
              throw new y("Expected list, minimum and maximum for LIST_RANGE");
            if (null === I.value) return p("targetList.value");
            let W = I.value.ListWithSubRange(A.valueObject, N.valueObject);
            this.state.PushEvaluationStack(new O(W));
            break;
          case k.CommandType.ListRandom: {
            ...
            this.state.PushEvaluationStack(new O(n));
            break;
          }
          default:
    ...
    ValidateExternalBindings() {
      ...
      if (
        ...
        for (let e of t.content) {
          (null != e && e.hasValidName) || this.ValidateExternalBindings(e, n);
        }
    ...
    TagsAtStartOfFlowContainerWithPathString(t) {
      ...
      for (let t of i.content) {
        let e = s(t, k);
        if (null != e)
          e.commandType == k.CommandType.BeginTag
            ? (r = !0)
            : e.commandType == k.CommandType.EndTag && (r = !1);
        else {
          if (!r) break;
          {
            let e = s(t, E);
            null !== e
              ? (null === a && (a = []), null !== e.value && a.push(e.value))
              : this.Error(
    ...
    NextSequenceShuffleIndex() {
      ...
      let r = i / n,
        ...
        o = e.path.toString(),
        h = 0;
      for (let t = 0, e = o.length; t < e; t++) h += o.charCodeAt(t) || 0;
      let u = h + r + this.state.storySeed,
        c = new z(Math.floor(u)),
        d = [];
