    ...
    <div className="resources">
      ...
      <div className="east">
        ...
        <ul>
          ...
          <li>prevent@norfolk.police.uk</li>
          <li>
            {" "}
            Make a referral online at{" "}
            <a href="https://www.norfolk.police.uk/advice/advice-and-information/t/prevent/prevent/beta/prevent-team-referral" />
          </li>
        </ul>
        ...
        <ul>
          ...
          <li>
            Make a referral online at{" "}
            <a href="https://www.suffolk.police.uk/advice/advice-and-information/t/prevent/prevent/beta/prevent-team-referral/"></a>
          </li>
        </ul>

        <p className="cambridge">Cambridgeshire & Peterborough Prevent Team</p>
        <li>01480 422596</li>
        <li>prevent@cambs.pnn.police.uk</li>
        <li>
          Make a referral online at{" "}
          <a href="https://www.cambs.police.uk/advice/advice-and-information/t/prevent/prevent/beta/prevent-team-referral/"></a>
        </li>
      </div>
      ...
      <div className="midlands">
        ...
        <ul>
          ...
          <li>
            Make a referral online at{" "}
            <a href="https://www.derbyshire.police.uk/advice/advice-and-information/t/prevent/prevent/beta/prevent-team-referral/"></a>
          </li>
        </ul>
        ...
        <ul>
          <li>0800 011 3764</li>
          <li>prevent@notts.police.uk</li>
          <li>
            <a href="Make a referral online at https://www.nottinghamshire.police.uk/advice/advice-and-information/t/prevent/prevent/beta/prevent-team-referral/"></a>
          </li>
        </ul>
        ...
        <ul>
          <li>
            ...
            <a href="https://www.leics.police.uk/advice/advice-and-information/t/prevent/prevent/beta/prevent-team-referral/"></a>
          </li>
        </ul>
      </div>
